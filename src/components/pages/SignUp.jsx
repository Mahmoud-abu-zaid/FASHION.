      ...
      <div className="bg-[#e5c643] py-[50px] text-white">
        <div className="text-center">
          ...
          <label htmlFor="userEmail" className="bg-white p-4 rounded-lg">
            <input className=" p-3 rounded-lg text-black" type="email" name="" id="userEmail" placeholder="Add your email here" required onChange={(e)=>setUserEmail(e.target.value)} />
